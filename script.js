...
function generatePassword() {
  ...
  // Using parseInt here to take the string entered value and turn it into an integer

  let passLength = parseInt(
    prompt("Enter the amount of characters between 8-128.")
  );
  ...
  // binary questions for character selection

  let passLowerCase = confirm(
  ...
  // for loop to randomize character selection to generate random password
